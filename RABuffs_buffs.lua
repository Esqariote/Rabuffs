...
RAB_Buffs = {
	...
	bogling = { name = "Bogling Root", identifiers = { { tooltip = "Fury of the Bogling", texture = "Spell_Nature_Strength", spellId = 5665 } }, grouping = "Melee", buffFunc = RAB_UseItem, itemId = 5206 },
